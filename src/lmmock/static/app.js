...
function renderTemplates() {
  ...
  for (const template of templates) {
    const button = document.createElement('button'); button.type = 'button'; button.className = 'template-card'; button.title = t(template.help); button.setAttribute('aria-label', `${t(template.name)}: ${t(template.help)}`);
